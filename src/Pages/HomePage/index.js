...
<div class="">
<div className="carousel-container rounded-xl h-screen overflow-hidden flex items-center justify-center">
<Carousel className="rounded-xl h-screen overflow-hidden">
